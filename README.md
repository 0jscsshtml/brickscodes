...
* Addtional action button added in to context menu copy action item. This will enable you to copy current active element ID styles to clipbord and reset all ID styles of this element.
...
* If there is no active class in the element's class list, reset the current active breakpoint ID style from the active element.
